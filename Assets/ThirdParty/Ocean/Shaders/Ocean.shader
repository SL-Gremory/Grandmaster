...
Shader "Mobile/Ocean" {
	...
	SubShader {
	    Tags { "RenderType" = "Opaque" "Queue"="Geometry" "Overlay" = "Grid" }
		LOD 8
			...
			half4 frag (v2f i) : COLOR {
				...
				//SHORELINES
					...
					//#if defined(UNITY_REVERSED_Z)
						//float zdepth = 1.0f - (1 - (tex2D(_CameraDepthTexture, i.ref).r))*100+0.5;
					//#else
						float zdepth = (1 - (tex2D(_CameraDepthTexture, i.ref).r));
					//#endif
